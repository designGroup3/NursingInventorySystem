...
INSERT INTO `loginsystem`.`inventory` (`Serial Number`, `Item`, `Subtype`, `Assigned to`, `Location`, `Checkoutable`, `Number in Stock`, `Last Processing Date`, `Last Processing Person`) VALUES ('ET474374601', 'Apple MAC OS X 10.4', 'Apple', 'Drew Hills', 'Nursing 161', 1, 0, '2017-09-20', 'Tester');
...
INSERT INTO `loginsystem`.`inventory` (`Serial Number`, `Item`, `Subtype`, `Assigned to`, `Location`, `Checkoutable`, `Number in Stock`, `Last Processing Date`, `Last Processing Person`) VALUES ('IP472802749', 'Adobe PhotoShop CS', 'Adobe', 'Drew Hills', 'Checkout', 1, 1, '2016-09-29', 'Bob');

INSERT INTO `loginsystem`.`inventory` (`Serial Number`, `Item`, `Subtype`, `Assigned to`, `Location`, `Checkoutable`, `Number in Stock`, `Last Processing Date`, `Last Processing Person`) VALUES ('TM852187346', 'HP PhotoSmart D7560 Printer', 'HP Printer', 'Mary Sue', 'Nursing 162', 0, 0, '2012-02-22', 'Joe');
