...
echo '<head>
      ...
      <div class="parent">
          <button class=\'help\' style="height:26px;" onclick="window.location.href=\'http://flowtime.be/wp-content/uploads/2016/01/Naamloosdocument.pdf\'">
              <i class=\'fa fa-question\'></i>
          </button>
      </div><br><br>
      <div class="center">
          <img src=QRCode.php?text='.$id.' width="135" height="125" title="QR Code" alt="QR Code">
          <p class="text">'.$serialNumber.'</p>
      </div><br><br>
      <div class="button"><br>
          <button class="btn btn-warning" style="text-align: center" onClick="window.print()">Print this page</button>
      </div>';
