...
"superAdmin" and the password "1234" for a super admin user, or use the username "admin" and the password "1234" for an
admin user, or use the username "Craig" and the password "1234" for a standard user.
