...
if(isset($_SESSION['id'])) {
    ...
    echo "<head><Title>Add Consumable Column</Title></head><div class=\"parent\"><button class=\"help\" onclick=\"window.location.href='http://flowtime.be/wp-content/uploads/2016/01/Naamloosdocument.pdf'\">
