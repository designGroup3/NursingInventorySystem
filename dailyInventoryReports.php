...
if(isset($_SESSION['id'])) {
    ...
    echo "<head>
          ...
          <body>
              <div class=\"parent\">
                  <button class=\"help\" style='height:27px;' onclick=\"window.location.href='./UserManual.pdf#page=48'\">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "SELECT `Activity Type`, `Serial Number`, Item, inventoryReports.Subtype, subtypes.Type, `Beginning Quantity`, `End Quantity`, Timestamp, `Update Person` FROM inventoryReports JOIN subtypes ON subtypes.Subtype = inventoryReports.Subtype WHERE Timestamp BETWEEN '".$date." 00:00:00' AND '".$date." 23:59:59';";
