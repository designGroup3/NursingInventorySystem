...
if(isset($_SESSION['id'])) {
    include 'dbh.php';
    echo "<head>
              <Title>Daily Consumable Reports</Title>
          </head>
          <body>
              <div class=\"parent\">
                  <button class=\"help\" style='height:27px;' onclick=\"window.location.href='http://flowtime.be/wp-content/uploads/2016/01/Naamloosdocument.pdf'\">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($resultCheck > 0) {
            echo "<br><h2 class='center'><b>&nbsp&nbspActivities for ".date_format($dateTitle, 'm/d/Y')."</b></h2><br>

                      <form class='center' action='dailyReportsExcel.php' method ='post'>
