...
if(isset($_POST["export"]))
{
    ...
    $sql = "SELECT `Activity Type`, Item, consumableReports.Subtype, subtypes.Type, `Beginning Quantity`, `End Quantity`, Timestamp, `Update Person` FROM consumableReports JOIN subtypes ON subtypes.Subtype = consumableReports.Subtype WHERE Timestamp BETWEEN '".$date." 00:00:00' AND '".$date." 23:59:59' ORDER BY Timestamp;";
