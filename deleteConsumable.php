...
if(isset($_SESSION['id'])) {
    ...
    echo "<head>
              <Title>Delete Consumable</Title>
          </head>
          <div class=\"parent\">
              <button class=\"help\" onclick=\"window.location.href='./UserManual.pdf#page=58'\">
    ...
    echo "<div class=\"container\">
              <form action ='includes/deleteConsumable.inc.php' class=\"well form-horizontal\" method ='POST' id=\"contact_form\">
                  <fieldset>
                      <h3 align=\"center\">Are you sure you want to delete ".$itemName."?</h3>
