...
if(isset($_SESSION['id'])) {
    include 'dbh.php';
    echo "<head>
              <Title>Edit Inventory Column</Title>
          </head>
          <div class=\"parent\">
              <button class=\"help\" onclick=\"window.location.href='./UserManual.pdf#page=46'\">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "SELECT DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'inventory' AND COLUMN_NAME = '".$oldColumn."';";
        $result = mysqli_query($conn, $sql);
        ...
        echo "<div class=\"form-group\">
                  <label class=\"col-md-4 control-label\">New Column Name:
                      <a style=\"color:red;\" title=\"This field must be filled\">*</a>
                  </label>
                  <div class=\"col-md-4 inputGroupContainer\">
                      <div class=\"input-group\">
                          ...
                          <input type='text' class=\"form-control\" required name='newColumn' value='".$oldColumn."'>
                      </div>
                  </div>
              </div>
        ...
        if($type == "varchar") {
            echo '<option selected value="Letters & Numbers">Letters & Numbers</option>
                  <option value="Yes or No">Yes or No</option>';
        }
        else{
            echo '<option value="Letters & Numbers">Letters & Numbers</option>
  ...
  <div class='form-group'>
      ...
      <div class='col-md-4'>
          <button type='submit' class=\"btn btn-warning btn-block\">Edit Column</button><br><br>
      </div>
  </div>
</form>
</fieldset>
