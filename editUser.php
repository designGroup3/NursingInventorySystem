...
if(isset($_SESSION['id'])) {
    include 'dbh.php';
    echo "<head><Title>Edit User</Title></head><div class=\"parent\"><button onclick=\"window.location.href='http://flowtime.be/wp-content/uploads/2016/01/Naamloosdocument.pdf'\">
