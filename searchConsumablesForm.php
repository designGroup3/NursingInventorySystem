...
if(isset($_SESSION['id'])) {
    include 'dbh.php';
    echo "<head>
              <Title>Search Consumables</Title>
          </head>
          <div class=\"parent\">
              <button class='help' onclick=\"window.location.href='./UserManual.pdf#page=42'\">
    ...
    echo "<br><div class=\"container\">
                  <form class='well form-horizontal' action ='searchConsumablesResults.php' method ='POST' id='contact_form'>
                      <fieldset>
                          <h2 align='center'>Search Consumables</h2><br>";
    ...
    echo "<div class=\"form-group\">
              ...
              <div class=\"col-md-4\">
                  <button name=\"submit\" type=\"submit\" class=\"btn btn-warning btn-block\" id=\"contact-submit\" data-submit=\"...Sending\">Search</button>
              </div>
          </div>
      </fieldset>
  </form>
