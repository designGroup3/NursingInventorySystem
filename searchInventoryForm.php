...
if(isset($_SESSION['id'])) {
    ...
    echo "<br><div class=\"container\">
                  <form action ='searchInventoryResults.php' class=\"well form-horizontal\" id=\"contact_form\" method ='POST'>
                      <fieldset>
                          <h2 align=\"center\">Search Inventory</h2><br>";
    for($count = 1; $count < 5; $count++){
        ...
        elseif($count == 3){
            ...
            echo "<div class=\"form-group\">
                      <label class=\"col-md-4 control-label\">Subtype:</label>
                          <div class=\"col-md-4 selectContainer\">
                              <div class=\"input-group\">
                                  <span class=\"input-group-addon\">
                ...
                echo "<div class=\"form-group\">
                          ...
                          <div class=\"col-md-4 inputGroupContainer\">
                              <div class=\"input-group\">
                                  ...
                                  <input name='SerialNumber' placeholder=\"Serial Number\" class=\"form-control\" type=\"text\">
                              </div>
                          </div>
                      </div>";
            }
                ...
                echo "<div class=\"form-group\">
                          ...
                          <div class=\"col-md-4 inputGroupContainer\">
                              <div class=\"input-group\">
                                  ...
                                  <input name='Item' placeholder=\"Item Name\" class=\"form-control\" type=\"text\">
                              </div>
                          </div>
                      </div>";
            }
            else {
                echo "&nbsp&nbsp<label>$columnNames[$count]</label><br>&nbsp&nbsp
                                <input type='text' name='".$columnName."' value='".$row[$columnNames[$count]]."'><br><br>";
            }
        }
    }
    ...
    for($count = 4; $count< count($columnNames); $count++){
        ...
        if($rowType['DATA_TYPE'] == "tinyint"){
            ...
            if($count == 6){
                $inputs = "<div class=\"form-group\">
                               <label class=\"col-md-4 control-label\">Checkoutable:</label>
                               <div class=\"col-md-4 inputGroupContainer\">
                                   <div class=\"input-group\">
                                       <span class=\"input-group-addon\">
        ...
        elseif($rowType['DATA_TYPE'] == "date"){
            if($count == 10){
                $inputs = "<div class='form-group'>
                               <label class='col-md-4 control-label'>Last Processing Date:</label>
                               <div class=\"col-md-4 inputGroupContainer\">
                                   <div class=\"input-group\">
                                       <span class=\"input-group-addon\">
        ...
        elseif($rowType['DATA_TYPE'] == "int"){
            if($count == 7){
                $inputs = "<div class=\"form-group\">
                               <label class=\"col-md-4 control-label\">Number in Stock:</label>
                               <div class=\"col-md-4 inputGroupContainer\">
                                   <div class=\"input-group\">
                                       <span class=\"input-group-addon\">
                                           <i class=\"glyphicon glyphicon-question-sign\"></i>
                ...
                $inputs = "&nbsp&nbsp<label>$columnNames[$count]:</label><br>&nbsp&nbsp
                ...
                $inputs = "<div class=\"form-group\">
                               ...
                               <div class=\"col-md-4 inputGroupContainer\">
                                   <div class=\"input-group\">
                                       ...
                                       <input name='Location' placeholder=\"Item's Location\" class=\"form-control\" type=\"text\">
                                   </div>
                               </div>
                           </div>";
            }
            ...
            elseif($count == 11){
                $inputs= "<div class='form-group'>
                              <label class='col-md-4 control-label'>Last Processing Person:</label>
                              <div class=\"col-md-4 inputGroupContainer\">
                                  <div class=\"input-group\">
                                      <span class='input-group-addon'>
                                          <i class='fa fa-user-circle' aria-hidden='true'></i>
                                      </span>
                                      <input name='LastProcessingPerson' placeholder='Last Processing Person' class=\"form-control\" type=\"text\">
                                  </div>
                              </div>
                          </div>";
            }
                ...
                $inputs = "<div class='form-group'>
                               ...
                               <div class=\"col-md-4 inputGroupContainer\">
                                   <div class=\"input-group\">
                                       ...
                                       <input name='$columnName' placeholder=\"$columnNames[$count]\" class='form-control' type='text'>
                                   </div>
                               </div>
                           </div>";
            }
    ...
    echo "<div class=\"form-group\">
              ...
              <div class=\"col-md-4\">
                  <button type='submit' class='btn btn-warning btn-block'>Search Inventory</button>
              </div>
          </div>
      </fieldset>
  </form>
