...
<?php
    ...
    if(isset($_SESSION['id'])){
        ...
        <div class=\"form-group\"><label class=\"col-md-4 control-label\">E-Mail<p style=\"color:red;font-size:10px;\">*required</p></label>  
        <div class=\"col-md-4 inputGroupContainer\"><div class=\"input-group\">
        ...
        <div class=\"form-group\"><label class=\"col-md-4 control-label\">Username<p style=\"color:red;font-size:10px;\">*required</p></label>  
        <div class=\"col-md-4 inputGroupContainer\"><div class=\"input-group\">
        <span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-user\"></i></span>
        <input type='text' class='form-control' placeholder='Username' name='uid'required></div></div></div>
        
        <div class=\"form-group\"><label class=\"col-md-4 control-label\" for=\"psw\">Password<p style=\"color:red;font-size:10px;\">*required</p></label>  
        <div class=\"col-md-4 inputGroupContainer\"><div class=\"input-group\">
