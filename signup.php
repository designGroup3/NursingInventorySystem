    ...
    if(isset($_SESSION['id'])){
        echo "<br>
              <div class=\"container\" style=\"text-align:center;\">
                  <form class=\"well form-horizontal\" action='includes/signup.inc.php' method='POST' id=\"contact_form\">
                      <fieldset>
                          ...
                          <div class=\"form-group\">
                              ...
                              <div class=\"col-md-4 inputGroupContainer\">
                                  <div class=\"input-group\">
                                      ...
                                      <input name='first' required placeholder='First Name' class=\"form-control\" type=\"text\">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class=\"form-group\">
                              ...
                              <div class=\"col-md-4 inputGroupContainer\">
                                  <div class=\"input-group\">
                                      ...
                                      <input name='last' required placeholder='Last Name' class='form-control' type='text'>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class=\"form-group\">
                              ...
                              <div class=\"col-md-4 inputGroupContainer\">
                                  <div class=\"input-group\">
                                      ...
                                      <input name='email' required placeholder='E-Mail Address' class='form-control' type='email'>
                                  </div>
                              </div>
                          </div>
  ...
  <div class=\"form-group\">
      ...
      <div class=\"col-md-4 inputGroupContainer\">
          <div class=\"input-group\">
              ...
              <input type='text' required class='form-control' placeholder='Username' name='uid'>
          </div>
      </div>
  </div>
    
  <div class=\"form-group\">
      <label class=\"col-md-4 control-label\" for=\"psw\">Password:
          <a style=\"color:red;\" title=\"This field must be filled\">*</a>
      </label>
      <div class=\"col-md-4 inputGroupContainer\">
          <div class=\"input-group\">
              ...
              <input name='pwd' placeholder='Password' class='form-control' type='password' id='pwd' pattern=\"(?!.*[\\\\])(?!.*[\'])(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,}\" title=\"Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters. Passwords cannot contain \ or '.\" required>
          </div>
      </div>
  </div>
  <div id=\"message\">
      ...
      <p id=\"void\" class=\"invalid\"><b>No</b> ' <b>or</b> \ </p>
  </div>
